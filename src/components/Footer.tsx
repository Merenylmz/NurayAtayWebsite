    ...
    <div className="relative">
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          ...
          <div className="">
            ...
            <div className="flex mt-5 space-x-5 text-gray-400 dark:text-gray-500">
              <a
                href="https://www.facebook.com/profile.php?id=61574089749450"
                target="_blank"
                rel="noopener"
              >
              ...
              <a
                href="https://www.instagram.com/nurayatayluxurybeauty/"
                target="_blank"
                rel="noopener"
              >
        ...
        <div className="my-10 text-sm text-center text-gray-600 dark:text-gray-400">
          Copyright © {new Date().getFullYear()}. Made with by<Link href={`https://quarkend.com`} target="_blank" style={{color: "blueviolet"}}>{" Quarkend "}</Link>
        </div>
      </Container>
      {/* Do not remove this */}
      <Backlink />
